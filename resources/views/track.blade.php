@extends('layout', ['page_title' => 'track order'])
    ...
    <div class="relative hidden md:block">
        ...
        <div class="flex">
            ...
            <div class="flex flex-col bg-white ml-4 mt-4 w-[62%] rounded-md p-8 text-sm space-y-4">
                <div class="text-2xl font-bold">How to track your order</div>
                <div class="text-lg"><span class="font-bold">Step 1:</span> Log into your account</div>
                <div class="text-lg"><span class="font-bold">Step 2:</span> Click on the <a href="orders"><span class="text-orange-500 font-bold text-sm">"ORDERS"</span> tab in your account dashboard</a></div>
                <div class="text-lg"><span class="font-bold">Step 3:</span> Find the order you want to track and click on <span class="font-bold">"See Details".</span></div>
                <div class="text-lg"><span class="font-bold">Step 4:</span> On the order details page, click on track my item to view the current status and a complete tracking history.</div>
                <div class="text-lg">Alternatively, once your order is shipped, you can also track your order by using your <span class="font-bold">"package number"</span> provided in your shipping email.
                    Simply enter the package number into jumia's <a href=""><span class="text-orange-500 text-sm font-bold">PACKAGE TRACKING PAGE</span></a> to view the latest update on your package.
                </div>
                <div class="text-lg">Stay updated on the status of your Jumia order and enjoy a seamless shopping experience by following these simple steps.</div>
