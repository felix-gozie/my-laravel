@extends('layout', ['page_title' => 'Save Items'])
        ...
        <div class="bg-gray-100 pt-5 pl-[7%] flex space-x-4">
            ...
            <div class="py-6 shadow-lg bg-white text-black w-[64%] text-black rounded-lg">
                ...
                <div class="pl-[47%] pt-[7%] text-orange-500 text-7xl">
                    <i class="fa-solid fa-heart pb-3"></i>
                </div>
            </div>
        </div>
...
<div class="bg-gray-100 mt-3 ">
    <div class="p-6 flex flex-col justify-center items-center md:hidden">
        <div class="bg-white p-6 rounded-full">
            <i class="fa-solid fa-heart text-orange-400 text-6xl"></i>
        </div>
        <p class="pt-2 text-lg">You haven't saved an item yet!</p>
        <p class="text-md">Found something you like? Tap on the heart shaped icon next to the item to add it to your wishlist! All your saved items will appear here.</p>
        <!-- Button starts here -->
