        ...
        <div class="flex">
            ...
            <div class="flex flex-col bg-white ml-4 mt-4 w-[62%] rounded-md p-8 text-sm space-y-4">
                <div class="flex flex-col" >
                    <a href="#" class="underline">Payments</a>
                    <a href="#" class="font-bold">What payment method is accepted on jumia?</a>
                </div>
                <div class="flex flex-col" >
                    <a href="#" class="underline">Payments</a>
                    <a href=""  class="font-bold">How secure is my payment method on jumia?</a>
                </div>
                <div class="flex flex-col">
                    <a href="#" class="underline">Payments</a>
                    <a href="" class="font-bold">What do i do if my payment is declined?</a>
                </div>
                <div class="flex flex-col">
                    <a href="#" class="underline">Payments</a>
                    <a href="#" class="font-bold">Can i pay cash on deliver for my orders?</a>
                </div>
                <div class="flex flex-col">
                    <a href="#" class="underline">Payments</a>
                    <a href="#" class="font-bold">What if i have been charged twice for the same order?</a>
                </div>
                <div class="flex flex-col">
                    <a href="#" class="underline">Payments</a>
                    <a href="#" class="font-bold">How do i know if my payment has been processed successfully?</a>
                </div>
                <div class="flex flex-col">
                    <a href="#" class="underline">Payments</a>
                    <a href="#" class="font-bold">What is jumia store credit? and how can i use it?</a>
                </div>
                <div class="flex flex-col">
                    <a href="#" class="underline">Payments</a>
                    <a href="#" class="font-bold">What is jumiaPay on delivery?</a>
                </div>
                <div class="flex flex-col">
                    <a href="#" class="underline">Payments</a>
                    <a href="#" class="font-bold">Can i cancel my order and get a refund after payment has been made?</a>
                </div>
                <div class="flex flex-col">
                    <a href="#" class="underline">Payments</a>
                    <a href="#" class="font-bold">How does it take for my payment to be processed?</a>
                </div>
                <div class="flex flex-col">
                    <a href="#" class="underline">Payments</a>
                    <a href="#" class="font-bold">How do i pay via bank transfer on delivery via jumia transfer on delivery?</a>
                </div>
                <div class="flex flex-col">
                    <a href="#" class="underline">Payments</a>
                    <a href="#" class="font-bold">How do i pay via USSD on delivery via jumiaPay on delivery?</a>
                </div>
            </div>
        </div>
