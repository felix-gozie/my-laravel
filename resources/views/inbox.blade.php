@extends('layout', ['page_title' => 'Inbox Messages'])
...
@section('content')
    ...
    <div class="bg-gray-100 p-6 flex flex-col justify-center items-center md:hidden">
        <div class="bg-white p-6 rounded-full">
            <i class="fa-regular fa-envelope-open text-orange-300 text-6xl"></i>
        </div>
        <p class="mt-4 text-lg">You dont have any messages</p> 
        <p class="text-sm">Here you will be able to see all the <br> Messages that we sent to you. Stay tuned</p>
    </div>
